...
def thirteen_new_price_lines_(candles: np.ndarray, T: np.ndarray) -> bool:
...
def thirteen_new_price_lines_no_trend(candles: np.ndarray, T: np.ndarray) -> bool:
    """Definition: thirteen candles of either color reaching a new high.
...
def thirteen_new_price_lines_opp_trend(candles: np.ndarray, T: np.ndarray) -> bool:
    """Definition: thirteen candles of either color reaching a new high.
